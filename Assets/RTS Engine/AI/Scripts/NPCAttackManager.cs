...
namespace RTSEngine
{
    ...
    /// <summary>
    /// Target picker for the NPCAttackManager component
    /// </summary>
    [System.Serializable]
    public class NPCAttackTargetPicker : TargetPicker<FactionEntity, CodeCategoryField> {
        ...
        {
            foreach (CodeCategoryField ccf in list)
    ...
    public class NPCAttackManager : NPCComponent
    {
        ...
        private NPCAttackTargetPicker targetPicker = new NPCAttackTargetPicker();
        ...
        public void SetTargetFaction()
        {
            ...
            FactionSlot[] activeFactions = gameMgr.GetFactions()
                ...
                .OrderByDescending(faction => attackResources.Sum(resource => gameMgr.ResourceMgr.GetResourceAmount(faction.ID, resource.GetName()))).ToArray();
